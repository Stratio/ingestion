...
//
//        handler = new MongoFilterHandler(new DateCheckpointType(), context);
...
//
//        handler = new MongoFilterHandler(null, context);
//        handler.updateCheckpoint(checkpoint);
//    }
//
//    @Test
...
//        when(context.get("mongoUri"))
//                .thenReturn("mongodb://" + getMongoHost() + "/" + DB_TEST + ".validCollection");
//        handler = spy(new MongoFilterHandler(new DateCheckpointType(), context));
//
